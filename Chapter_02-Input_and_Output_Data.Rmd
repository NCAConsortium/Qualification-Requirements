...
* Dosing inputs:
    ...
    * Dose time inputs (all are zero for single-dose):
        * Nominal time or nonimal start time of reference dose 
        * Actual time or actual start time of reference dose
...
* (Optional) vector of exclusion flags. Value is "Y" or "1" if a concentration-time value pair is excluded
